...
import { Modal, Form, Col, Row, Input, Button, message } from "antd";
...
function TheatreFormModal({ isModalOpen, setIsModalOpen, formType, selectedTheatre, setSelectedTheatre, getData }) {
