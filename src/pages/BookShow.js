...
const BookShow = () => {
  ...
  const getData = async () => {
    try {
      ...
      if (response.success && response.data) {
        ...
        message.error(response.message || "Show not found!");
      }
  ...
  const getSeats = () => {
    let columns = 12;
    let totalSeats = show.totalSeats; // 240   
            ...
            >
              ...
              {selectedSeats.length > 0 && (
                ...
                //currency="INR"
                  ...
                  stripeKey="pk_test_51QsUZ5EQAXOLWxThn8XBlmP4vGSIXZtV9DeVocvSS6UOmXzBBN99ih6lZlK68xsvnKt7UZ5gKUIlZh5908uPF8cO00Afre8gVU"
                >
